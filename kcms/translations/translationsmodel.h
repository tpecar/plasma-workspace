...
public:
    enum AdditionalRoles {
        ...
        LanguageCode,
        IsMissing, // immutable, a missing language is always missing
...
private:
    ...
    QStringList m_languageCodes = KLocalizedString::availableDomainTranslations("plasmashell").values();
    LanguageVector m_languages = makeLanguages(m_languageCodes);
